    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        ...
        switch(sensorType){
            case Sensor.TYPE_PRESSURE:
                sensorValueTextView.setText(getResources().getString(R.string.sensor_label_value_pressure, sensorEvent.values[0]));
                break;
            case Sensor.TYPE_LIGHT:
                sensorValueTextView.setText(getResources().getString(R.string.sensor_label_value_light, sensorEvent.values[0]));
                break;
            case Sensor.TYPE_ACCELEROMETER:
                sensorValueTextView.setText(getResources().getString(R.string.sensor_label_value_accelometr, sensorEvent.values[0], sensorEvent.values[1], sensorEvent.values[2]));
                break;
            case Sensor.TYPE_STEP_COUNTER:
                sensorValueTextView.setText(getResources().getString(R.string.sensor_label_value, sensorEvent.values[0]));
                break;
